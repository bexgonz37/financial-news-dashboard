// Simple Working Scanner API - Guaranteed to Work
...
module.exports = async function handler(req, res) {
  ...
  try {
    console.log('=== SIMPLE SCANNER API - GUARANTEED TO WORK ===');
    console.log('Current time:', new Date().toISOString());
    console.log('Request query:', req.query);

    // Always return working stock data
    const stocks = generateWorkingStocks();
...
function generateWorkingStocks() {
  console.log('Generating working stock data...');
